                ...
                <div class="row">
                    ...
                    <div class="col-50">
                        ...
                        <div class="rs-select2--light rs-select2--md">
                            ...
                            <select  style="width: 95px; margin-left: 15px" class="js-select2" name="Phone_Brand">
                        ...
                        <div class="rs-select2--light rs-select2--md">
                            ...
                            <select style="width: 95px" class="js-select2" name="Device">
                                <option selected="selected">None</option>
                        ...
                        <div class="rs-select2--light rs-select2--md">
                            ...
                            <select style="width: 95px; margin-left: 5px" class="js-select2" name="Color">
                                <option selected="selected">None</option>
